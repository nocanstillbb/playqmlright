...
async def main():
    ...
    # ── Key Press ──
    await step("13. Focus key area, send Ctrl+A / F5 / Space")
    ...
    # ── Scroll ──
    await step("14. Scroll list down 5 notches")
    ...
    # ── Drag (Slider) ──
    await step("15. Drag slider: 50 → 80")
    ...
    await step("17. Drag slider: → 50 (reset)")
